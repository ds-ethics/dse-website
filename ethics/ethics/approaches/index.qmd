---
title: "Approaches"
subtitle: "Three approaches for Data Science Ethics — and why you should think about how you approach the ethics of data science"
author:
...
Data science ethics is often seen through the frameworks of responsibility or bias. We add to this the moral practice approach.
:::
...
The first important form of bias is **cognitive bias**, that is, problematic habits of thought, associations, or assumptions. The ethics of data science might be about the cognitive biases, or at least, the biases of its practitioners. As one prominent slogan goes: "All models are biased because humans are biased." ::: aside What makes some biases *problematic* and other OK is actually a very tricky question. :::
...
I think it is. The appraoch can work under the right conditions. Creating these conditions is up to every team leader. In fact, the **greatest threat to moral progress is cynicism**. I want to positively reject the cynicism behind the suggestion that "this appraoch is not going to work anyway."
